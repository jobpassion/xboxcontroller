...
static const uint8_t devInfoSerialNumber[] = "000000";
...
static const uint8_t devInfoMfrName[] = "HHL";
...
static uint8_t devInfoPnpId[DEVINFO_PNP_ID_LEN] = {
    1,                                    // Vendor ID source (1=Bluetooth SIG)
    LO_UINT16(HID_VEND_XINPUT), HI_UINT16(HID_VEND_XINPUT), // Vendor ID (WCH)
    LO_UINT16(HID_PROD_XINPUT), HI_UINT16(HID_PROD_XINPUT), // Product ID (vendor-specific)
    LO_UINT16(0x0000), HI_UINT16(0x0000)  // Product version (JJ.M.N)
};
