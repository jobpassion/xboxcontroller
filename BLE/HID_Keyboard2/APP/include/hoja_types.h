...
typedef enum
{
    HOJA_STATUS_DISCONNECT        = 0, // HOJA not loaded. Needs initialization.
	HOJA_STATUS_PAIRING = 1,
    HOJA_STATUS_CONNECTED = 2, // API has been initialized
} hoja_connect_status_t;
