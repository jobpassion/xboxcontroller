...
#define BUTTON_A_PIN        GPIO_Pin_0
    ...
    // DPAD
    #define DPAD_UP_PIN         GPIO_Pin_2
    #define DPAD_DOWN_PIN       GPIO_Pin_3
    #define DPAD_LEFT_PIN       GPIO_Pin_4
    #define DPAD_RIGHT_PIN      GPIO_Pin_5

    // Triggers
    #define TRIGGER_L_PIN       GPIO_Pin_6
    #define TRIGGER_R_PIN       GPIO_Pin_7
    #define TRIGGER_Z_PIN       GPIO_Pin_8
    #define TRIGGER_ZR_PIN      GPIO_Pin_9

    // MISC
    #define BUTTON_START_PIN    GPIO_Pin_10
    #define BUTTON_HOME_PIN     GPIO_Pin_11

    // C-Buttons
    #define C_UP_PIN            GPIO_Pin_12
    #define C_DOWN_PIN          GPIO_Pin_13
    #define C_LEFT_PIN          GPIO_Pin_14
    #define C_RIGHT_PIN         GPIO_Pin_15

    // Joystick
    #define JOYSTICK_X_INT_PIN  GPIO_Pin_17
    #define JOYSTICK_X_Q_PIN    GPIO_Pin_18
    #define JOYSTICK_Y_INT_PIN  GPIO_Pin_19
    #define JOYSTICK_Y_Q_PIN    GPIO_Pin_20
